...
- APP_VERBOSE       : Define global verbose level (ERROR,WARNING,INFO,DEBUG,EXTRA,QUIET or 0-5) default:INFO
- APP_VERBOSE_[lib] : Verbose level per library, overrides global (lib=[RMN,FST,WB,VGRID,INTERPV,GEOREF,RPNMPI,IRIS,IO])
- APP_VERBOSE_COLOR : Use color in log messages
- APP_VERBOSE_TIME  : Display time for each message (NONE,DATETIME,TIME,SECOND,MSECOND, or 0-4) default:NONE
