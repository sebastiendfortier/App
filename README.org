...
* Usage
This packages manages various standard tasks needed by applications like argument parsing, logging, process signal trapping, and some parallel process management
