module app
    ...
    enum, bind(C) 
       ...
       enumerator :: APP_MAIN=0, APP_LIBRMN=1, APP_LIBFST=2, APP_LIBWB=3, APP_LIBVGRID=4, APP_LIBINTERPV=5, APP_LIBGEOREF=6, APP_LIBRPNMPI=7, APP_LIBIRIS=8, APP_LIBIO=9, APP_LIBMDLUTIL=10, APP_LIBGEMDYN=11, APP_LIBRPNPHY=12
