...
typedef enum { APP_MAIN=0,APP_LIBRMN=1,APP_LIBFST=2,APP_LIBWB=3,APP_LIBGMM=4,APP_LIBVGRID=5,APP_LIBINTERPV=6,APP_LIBGEOREF=7,APP_LIBRPNMPI=8,APP_LIBIRIS=9,APP_LIBIO=10,APP_LIBMDLUTIL=11,APP_LIBGEMDYN=12,APP_LIBRPNPHY=13,APP_LIBMIDAS=14,APP_LIBEER=15 } TApp_Lib;
